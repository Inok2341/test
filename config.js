...
if (!gg) {
  gg = "6287754781718";   // You can Change this number //
}
...
global.mongodb = process.env.MONGODB || "mongodb+srv://Inok:Inok@cluster0.jdj4zsh.mongodb.net/?retryWrites=true&w=majority";
