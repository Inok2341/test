...
async function startMiku() {
    ...
    Miku.ev.on('connection.update', async (update) => {
        ...
        status = connection;
        if (connection) {
            await console.info(`Polaris Server Status => ${connection}`);
          }
...
//               Miku.sendMessage(62895600946278 + "@s.whatsapp.net", { text: `Perubahan Harga Axis ketik perintah /chaxis untuk melihat list harga` }); // Tri sutridno
//               Miku.sendMessage(6282379789175 + "@s.whatsapp.net", { text: `Perubahan Harga Axis ketik perintah /chaxis untuk melihat list harga` }); //dinda
//               Miku.sendMessage(6289691307232 + "@s.whatsapp.net", { text: `Perubahan Harga Axis ketik perintah /chaxis untuk melihat list harga` }); // kenan
//               Miku.sendMessage(6289652078501 + "@s.whatsapp.net", { text: `Perubahan Harga Axis ketik perintah /chaxis untuk melihat list harga` }); //Sari
//               Miku.sendMessage(62895600946278 + "@s.whatsapp.net", { text: `/menu` }); //
